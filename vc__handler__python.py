...
__vc_spec = util.spec_from_file_location("api.jcz.words_to_jyutping", "./api/jcz/words_to_jyutping.py")
__vc_module = util.module_from_spec(__vc_spec)
sys.modules["api.jcz.words_to_jyutping"] = __vc_module
...
if 'handler' in __vc_variables or 'Handler' in __vc_variables:
    ...
    print('Missing variable `handler` or `app` in file "api/jcz/words_to_jyutping.py".')
    print('See the docs: https://vercel.com/docs/functions/serverless-functions/runtimes/python')
    exit(1)
